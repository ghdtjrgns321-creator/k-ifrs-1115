...
기준서가 가진 명시적 관계를 노드·간선으로 옮긴 지식그래프(`data/ontology/`). 개념 80개를 허브로, 문단·사례·용어·BC가 관계로 연결된다.

[![K-IFRS 1115 지식그래프 3D 시각화 — 개념(허브) 노드에 문단·사례·용어·BC가 관계 간선으로 연결된 구조](images/knowledge_graph_3d.png)](https://raw.githack.com/ghdtjrgns321-creator/k-ifrs-1115/develop/graph-3d.html)

> 이미지를 클릭하면 회전·확대·노드 클릭이 가능한 **인터랙티브 3D 뷰어**가 열린다.
