...
범용 LLM으로 회계 기준서를 해석하면 근거 없는 답변, 곧 **환각**이 나오기 쉽다. 이는 AI를 과대신뢰하는 2종 오류로 이어진다. 이 시스템은 유연성을 포기하고 **무결성**에 집중한다.
...
> 통과율 88.7%의 Issue 6건은 "토픽 매칭이 기대와 다름(답변은 정확)", "응답 시간이 긴 편" 수준의 **메타데이터·완성도 이슈**다. 잘못된 정보를 만들거나 근거 없이 단정한 사례는 **0건**이다.
